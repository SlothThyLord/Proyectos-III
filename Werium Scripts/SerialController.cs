...
public class SerialController : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        while (portName == "") {
            ...
            //   int set = setPort("COM5");
            //  int open = OpenPort("COM5");
                ...
                if (open==1 & set==1)
                {
                    try {
                        ...
                        bool first_char = message.StartsWith("#");
                        if (first_char) {
                            portName = portName1;
                            mensaje.text = "Encontrado!!!"+portName;
                            break;
                        }
                    }
                    catch{
        ...
        thread.Start();
        mensaje.text = "Encontrado1!!!" + portName;
        // Esperar 2 segundos
